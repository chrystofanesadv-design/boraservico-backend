Write-Host "========================================="
Write-Host "INSTALANDO REFERRAL SYSTEM 2 FASES"
Write-Host "========================================="

$backend = "C:\Users\chrys\boraservico-backend"
$referral = "$backend\src\referral"

New-Item -ItemType Directory -Force -Path $referral | Out-Null
...
'@ | Set-Content "$referral\referral.service.ts" -Encoding UTF8
...
'@ | Set-Content "$referral\referral.controller.ts" -Encoding UTF8
...
'@ | Set-Content "$referral\referral.module.ts" -Encoding UTF8

$appModule = "$backend\src\app.module.ts"
$appContent = Get-Content $appModule -Raw

if ($appContent -notmatch "ReferralModule") {
...
Write-Host "========================================="
Write-Host "REFERRAL SYSTEM 2 FASES INSTALADO"
Write-Host "========================================="